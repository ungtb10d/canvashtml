        ...
        describe('parsing', function () {
            describe('url', function () {
                it('url(test.jpg)', function () {
                    return (0, assert_1.deepStrictEqual)(parse(context, 'url(http://example.com/test.jpg)'), {
            ...
            describe('linear-gradient', function () {
                it('linear-gradient(#f69d3c, #3f87a6)', function () {
                    return (0, assert_1.deepStrictEqual)(parse(context, 'linear-gradient(#f69d3c, #3f87a6)'), {
                ...
                it('linear-gradient(yellow, blue)', function () {
                    return (0, assert_1.deepStrictEqual)(parse(context, 'linear-gradient(yellow, blue)'), {
                        angle: (0, angle_1.deg)(180),
                        type: 1 /* CSSImageType.LINEAR_GRADIENT */,
                        stops: [
                ...
                it('linear-gradient(to bottom, yellow, blue)', function () {
                    return (0, assert_1.deepStrictEqual)(parse(context, 'linear-gradient(to bottom, yellow, blue)'), {
                        angle: (0, angle_1.deg)(180),
                        type: 1 /* CSSImageType.LINEAR_GRADIENT */,
                        stops: [
                            { color: colorParse(context, 'yellow'), stop: null },
                ...
                it('linear-gradient(180deg, yellow, blue)', function () {
                    return (0, assert_1.deepStrictEqual)(parse(context, 'linear-gradient(180deg, yellow, blue)'), {
                        angle: (0, angle_1.deg)(180),
                        type: 1 /* CSSImageType.LINEAR_GRADIENT */,
                        stops: [
                            { color: colorParse(context, 'yellow'), stop: null },
                ...
                it('linear-gradient(to top, blue, yellow)', function () {
                    return (0, assert_1.deepStrictEqual)(parse(context, 'linear-gradient(to top, blue, yellow)'), {
                        angle: 0,
                        type: 1 /* CSSImageType.LINEAR_GRADIENT */,
                        stops: [
                            { color: colorParse(context, 'blue'), stop: null },
                ...
                it('linear-gradient(to top right, blue, yellow)', function () {
                    return (0, assert_1.deepStrictEqual)(parse(context, 'linear-gradient(to top right, blue, yellow)'), {
                        angle: [
                ...
                it('linear-gradient(to bottom, yellow 0%, blue 100%)', function () {
                    return (0, assert_1.deepStrictEqual)(parse(context, 'linear-gradient(to bottom, yellow 0%, blue 100%)'), {
                        angle: (0, angle_1.deg)(180),
                        type: 1 /* CSSImageType.LINEAR_GRADIENT */,
                        stops: [
                            {
                ...
                it('linear-gradient(to top left, lightpink, lightpink 5px, white 5px, white 10px)', function () {
                    return (0, assert_1.deepStrictEqual)(parse(context, 'linear-gradient(to top left, lightpink, lightpink 5px, white 5px, white 10px)'), {
                        angle: [
                            { type: 16 /* TokenType.PERCENTAGE_TOKEN */, number: 100, flags: 4 },
                            { type: 16 /* TokenType.PERCENTAGE_TOKEN */, number: 100, flags: 4 }
                        ],
            ...
            describe('-prefix-linear-gradient', function () {
                it('-webkit-linear-gradient(left, #cedbe9 0%, #aac5de 17%, #3a8bc2 84%, #26558b 100%)', function () {
                    return (0, assert_1.deepStrictEqual)(parse(context, '-webkit-linear-gradient(left, #cedbe9 0%, #aac5de 17%, #3a8bc2 84%, #26558b 100%)'), {
                ...
                it('-moz-linear-gradient(top, #cce5f4 0%, #00263c 100%)', function () {
                    return (0, assert_1.deepStrictEqual)(parse(context, '-moz-linear-gradient(top, #cce5f4 0%, #00263c 100%)'), {
                        angle: (0, angle_1.deg)(180),
                        type: 1 /* CSSImageType.LINEAR_GRADIENT */,
                        stops: [
                            {
